...
<!-- Three variation of blog post -->
			...
			<div class="mobile_spacing" >
				...
				<div class="post_image  border2 dark_border">
					<a  href="blog.html" target="_self">
                    	<img class="scale-with-grid" src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/post_1.jpg" />
			...
			<div class="five columns alpha" >
				<div class="mobile_spacing" >
                    ...
                    <div class="medium_image img-align-left border2 dark_border">
                        <a class="single_image" title="Some text"  href="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/portfolio/image1.jpg" target="_self">
                        	<img class="scale-with-grid" src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/post_2.jpg" />
		...
		<div class="eleven columns alpha"   >
            ...
            <!-- Title-->
				...
				<div class="post_image  border2 dark_border">
					<a  href="blog.html" target="_self">
                    	<img class="scale-with-grid" src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/post_3.jpg" />
                        <div class="overlay link"></div>
                  	</a>
				</div>
