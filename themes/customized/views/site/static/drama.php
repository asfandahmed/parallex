...
<div class="staticContent parallax" data-id="drama" data-src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/parallax/image4.jpg" data-src-small="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/parallax/image4_s.jpg">                	
    <div class="container" >
		...
		<div class="sixteen columns" >
				...
				<div class="program" itemscope itemtype="http://schema.org/MusicVideoObject">
                    ...
                    <img  src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/portfolio/thumb1.jpg" class="thumbnail" alt="Wonder" itemprop="image"/>
									...
									<section id="comments-sec">
										...
										<ol class="comment-list">
											...
											<li class="comment">
												<article> 
													<!-- author -->
													<img class="avatar" alt="Image" src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/post_aut_1.jpg">
											...
											<li class="comment">
												<article> 
													<!-- author -->
													<img class="avatar" alt="Image" src="<?php echo Yii::app()->request->baseUrl;?>/themes/customized/images/post_aut_2.jpg">
													<div class="comment-aut">
