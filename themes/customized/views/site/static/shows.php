									...
									<section id="comments-sec">
										...
										<ol class="comment-list">
											...
											<li class="comment">
												<article> 
													<!-- author -->
													<img class="avatar" alt="Image" src="<?php Yii::app()->request->baseUrl;?>/themes/customized/images/post_aut_1.jpg">
											...
											<li class="comment">
												<article> 
													<!-- author -->
													<img class="avatar" alt="Image" src="<?php Yii::app()->request->baseUrl;?>/themes/customized/images/post_aut_2.jpg">
													<div class="comment-aut">
